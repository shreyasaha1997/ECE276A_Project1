...
def panorama_stitching(args, qs, qs_ts, cam_imgs, cam_ts):
    ...
    i=0
    for q, img in tqdm(zip(predicted_qs[250:350],imgs[250:350])):
    ...
    imageio.imwrite(args.basedir + '/' + args.dataset + '/logs/panorama.png', output_image.astype(np.uint8))
    return